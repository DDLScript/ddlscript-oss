<template>
	...
	<ddlscript-layout-threecolumn>
		...
		<ddlscript-element-panel hue="foreground" title="Merge Requests Awaiting Your Review">
			<div style='padding:4rem 0;text-align:center;'>
				<ddlscript-element-busyspinner />
			</div>
		</ddlscript-element-panel>
	...
	<div style='padding:2rem 1rem 4rem;opacity:0.666;text-align:center;'>
		<small>Copyright &copy; 2017-{{ new Date().getFullYear() }} DDL Script.<br />DDL Script is open sounce and can be found on <a href='https://github.com/ddlscript/ddlscript-oss' target='_blank' style='text-decoration:underline;'>GitHub</a></small>
	</div>
</template>
